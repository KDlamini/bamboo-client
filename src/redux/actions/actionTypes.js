...
export const AUTH_ERROR = 'Shopcart/api/AUTH_ERROR';
export const LOGIN_SUCCESS = 'Shopcart/api/LOGIN_SUCCESS';
export const LOGIN_FAIL = 'Shopcart/api/LOGIN_FAIL';
export const LOGOUT_SUCCESS = 'Shopcart/api/LOGOUT_SUCCESS';
export const REGISTER_SUCCESS = 'Shopcart/api/REGISTER_SUCCESS';
